...
class TurtleBot:
    ...
    def __init__(self):
        ...
        self._rayon = rospy.get_param('~rayon')
        self._x_centre = rospy.get_param('~x_centre')
        self._y_centre = rospy.get_param('~y_centre')
        self._freq = rospy.get_param('~freq')
        self._tour = rospy.get_param('~tour')
    ...
    def move2goal(self):
        ...
        goal_pose.x = self._x_centre
        goal_pose.y = self._y_centre
